...
Having problems? <a href="admin.php?page=sp-client-document-manager-settings&force_upgrade=1&force_upgrades=1">Click here to make sure your database structure is correct</a>
  ...
  echo' <tr>
    ...
    <td><input type="text" name="sp_cu_thankyou"  value="' .esc_attr( get_option('sp_cu_thankyou') ). '"  size=80"> </td>
    ...
    <td><input type="text" name="sp_cu_delete"  value="' . esc_attr(get_option('sp_cu_delete') ). '"  size=80"> </td>
    ...
    <td><input type="text" name="sp_cdm_permission_error_download"  value="' . esc_attr(get_option('sp_cdm_permission_error_download', '404: File not found') ). '"  size=80"> </td>
